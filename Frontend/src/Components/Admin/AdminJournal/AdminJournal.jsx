...
const AdminJournal = () => {
  ...
  const { fetchData: fetchUpdateData } = useFetch(
    `https://ten-virtual-aggregator.onrender.com/api/updatejournal/${selectedOne}`,
    "PUT"
  );

  const { fetchData: fetchNewData } = useFetch(
    `https://ten-virtual-aggregator.onrender.com/api/newjournal`,
    "POST"
  );
  ...
  const { fetchData: fetchDelete } = useFetch(
    `https://ten-virtual-aggregator.onrender.com/api/deletejournal`,
    "DELETE"
  );
